...
<main class="form-signin w-100 m-auto">
  <form method="post" action="login.inc.php">
    <h1 class="h3 mb-3 fw-normal">Login met uw gegevens</h1>
    ...
    <input class="btn btn-dark w-100 py-2" type="submit" name="login" value="Log in"></input>
  </form>
</main>
<style>
	footer {
